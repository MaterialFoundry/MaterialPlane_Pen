 ...
 */
static inline void testPin_set_pull_mode(const enum port_pull_mode pull_mode)
{
	PORTA_set_pin_pull_mode(1, pull_mode);
}

/**
 * \brief Set testPin data direction
 *
 ...
 *                      (low power state)
 */
static inline void testPin_set_dir(const enum port_dir dir)
{
	PORTA_set_pin_dir(1, dir);
}

/**
 * \brief Set testPin input/sense configuration
 *
 * Enable/disable testPin digital input buffer and pin change interrupt,
 ...
 */
static inline void testPin_set_isc(const PORT_ISC_t isc)
{
	PORTA_pin_set_isc(1, isc);
}

/**
 * \brief Set testPin inverted mode
 *
 * Enable or disable inverted I/O on a pin
 *
 * \param[in] inverted true  = I/O on testPin is inverted
 *                     false = I/O on testPin is not inverted
 */
static inline void testPin_set_inverted(const bool inverted)
{
	PORTA_pin_set_inverted(1, inverted);
}

/**
 * \brief Set testPin level
 *
 ...
 */
static inline void testPin_set_level(const bool level)
{
	PORTA_set_pin_level(1, level);
}

/**
 * \brief Toggle output level on testPin
 *
 * Toggle the pin level
 */
static inline void testPin_toggle_level()
{
	PORTA_toggle_pin_level(1);
}

/**
 * \brief Get level on testPin
 *
 * Reads the level on a pin
 */
static inline bool testPin_get_level()
{
